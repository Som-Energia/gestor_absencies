# Generated by Django 2.1.7 on 2019-04-12 10:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('holidays', models.DecimalField(decimal_places=1, default=0, max_digits=10, verbose_name='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('base_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='gestor_absencies.Base')),
                ('name', models.CharField(help_text='Absece type name', max_length=50, unique=True, verbose_name='Absece type name')),
                ('description', models.CharField(help_text='Absece type description', max_length=250, verbose_name='Absece type description')),
                ('spend_days', models.IntegerField(default=0, verbose_name='')),
                ...
                ('max_spend', models.DecimalField(decimal_places=1, default=0, max_digits=10, verbose_name='')),
                ('min_spend', models.DecimalField(decimal_places=1, default=0, max_digits=10, verbose_name='')),
                ('required_notify', models.BooleanField(default=True, verbose_name='')),
            ],
            bases=('gestor_absencies.base',),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('base_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='gestor_absencies.Base')),
                ('start_time', models.DateTimeField(help_text='Date when this occurrence end', verbose_name='End time occurrence')),
                ('end_time', models.DateTimeField(help_text='Date when this occurrence end', verbose_name='End time occurrence')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_worker', models.IntegerField(default=0, verbose_name='')),
